...
export default function Consola() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!newErrors.gameName && !newErrors.age && !newErrors.gameRating) {
      ...
      const updatedList = [...consolaGamesList, newGame].sort(
        (a, b) => b.gameRating - a.gameRating
      );

      // Salvează în localStorage
      setconsolaGamesList(updatedList);
      localStorage.setItem("consolaGamesList", JSON.stringify(updatedList));
  ...
  return (
    <div className="consola" style={{ display: "flex" }}>
      <div style={{ marginLeft: "0px" }}>
        <img
          src="images/ps4-clipart-playstation-game-console-and-various-controllers-cartoon-vector_554178_wh1200-removebg-preview.png"
          style={{
            width: "500px",
            height: "auto",
            marginTop: "80px",
